...
{
	unsigned char  Index[3];            // 汉字内码索引,一个汉字占两个字节(utf-8:中文占3个字节)	
	unsigned char  Msk[32];             // 点阵码数据(16*16有32个数据) 
};

// >>> '普中科技有限公司'.encode('utf-8') 
// b'\xe6\x99\xae\xe4\xb8\xad\xe7\xa7\x91\xe6\x8a\x80\xe6\x9c\x89\xe9\x99\x90\xe5\x85\xac\xe5\x8f\xb8'
