...
void datapros(int temp)
{
    ...
    SegDisplayData[1]=NsegCode[(temp/1000)];//125
    SegDisplayData[2]=NsegCode[(temp%1000/100)];//25
    SegDisplayData[3]=NsegCode[(temp%100/10)]|0x80;//5
    SegDisplayData[4]=NsegCode[(temp%100%10)];//.5
}
